...
print(torch.allclose(dq_flash, dq_flash_manual, atol=1e-6))
print(torch.allclose(dk_flash, dk_flash_manual, atol=1e-6))
print(torch.allclose(dv_flash, dv_flash_manual, atol=1e-6))