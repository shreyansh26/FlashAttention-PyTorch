...
dq_flash, dk_flash, dv_flash = jacrev(value_fn, argnums=(1,2,3))(flash_attention_causal, *args)
dq_normal, dk_normal, dv_normal = jacrev(value_fn, argnums=(1,2,3))(normal_attention_causal, *args)
